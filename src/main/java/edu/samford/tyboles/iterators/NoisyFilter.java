...
public class NoisyFilter {
    ...
    /**
     * Generate data between low and high with 1-noiseprob probability otherwise generate some random data
     * 
     * @param low
     * @param high
     * @param noiseprob
    ...
    // we are creating temperatures and averaging them but some temperatures are outliers
    // like 25 degrees talking about summer degrees in Alabama
    // these outliers are called noisy data
    // so we are generating this, then are gonna filter the noisy data/outliers out
    ...
    private static void generateNoisyData(int low, int high, double noiseprob) {
        ...
        // second part of the assisgnment is to change this percentage
        // generate a noisy reading
            
                temps.insertLast(r.nextInt(50));

            } else {
                //generate typical Alabama summer temperature reading
    ...
    /**
     * Remove any data outside of the expected range
     * @param low
     * @param high 
     */
